...
public class BlackAdapter extends BaseAdapter {
	...
	public BlackAdapter(Context context,List<ContactBean> list,OnClickListener onClickListener){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		viewHolder.delete.setTag(contactBean.getNick()+","+1+","+contactBean.getContact_id()+","+contactBean.getNumber());
