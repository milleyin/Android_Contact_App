...
public class NoteBookContentProvider extends ContentProvider {
	...
	private static final String AUTHORITY = "com.dongji.app.addressbook.notebook";
	private static final String table = NoteBookDBHepler.table;
	
	private NoteBookDBHepler noteBookOpenHepler;
	...
	protected static final String PROJECTION[] = {
		NoteBookDBHepler._ID,
		NoteBookDBHepler.CONTENT,
		NoteBookDBHepler.DATE_TIME
	};
	...
	public Uri insert(Uri uri, ContentValues values) {
		// TODO Auto-generated method stub
		long rowCount = DatabaseUtils.queryNumEntries(noteBookOpenHepler.getReadableDatabase(), table);
		if(rowCount > noteBookOpenHepler.NOTEBOOK_MAX_ROW){
	...
	public int update(Uri uri, ContentValues values, String selection,
		...
		switch(matchId) {
			case all :
				...
				break;
			case single:
				where = NoteBookDBHepler._ID + "=" + uri.getPathSegments().get(1);
				break;
			default :
