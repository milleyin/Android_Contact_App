...
public class PhoneDetailAdapter extends BaseAdapter {
	...
	public PhoneDetailAdapter(AddContactActivity addContactLayout,Context context, String name,String[] numbers) {
	...
	public PhoneDetailAdapter(RemindsActivity remindLayout,Context context, String name,String[] numbers) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		convertView = LayoutInflater.from(context).inflate(R.layout.phone_detail_list_item, null);
