...
import com.dongji.app.entity.OnWheelScrollListener;
import com.dongji.app.entity.WheelAdapter;
...
public class WheelView extends View {
	...
	private void initResourcesIfNecessary() {
		if (itemsPaint == null) {
			...
			itemsPaint.setTextSize(getResources().getDimensionPixelSize(R.dimen.wheel_size));
...
//			 valuePaint.density = getResources().getDisplayMetrics().density;
			valuePaint.setTextSize(getResources().getDimensionPixelSize(R.dimen.wheel_size));
