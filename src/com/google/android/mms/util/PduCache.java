...
public final class PduCache extends AbstractCache<Uri, PduCacheEntry> {
    ...
    static {
        ...
        MATCH_TO_MSGBOX_ID_MAP.put(MMS_INBOX,  1); //Mms.MESSAGE_BOX_INBOX
        MATCH_TO_MSGBOX_ID_MAP.put(MMS_SENT,   2);  //Mms.MESSAGE_BOX_SENT
        MATCH_TO_MSGBOX_ID_MAP.put(MMS_DRAFTS, 3);  //Mms.MESSAGE_BOX_DRAFTS
        MATCH_TO_MSGBOX_ID_MAP.put(MMS_OUTBOX, 4);  //Mms.MESSAGE_BOX_OUTBOX
    }
    ...
    synchronized public PduCacheEntry purge(Uri uri) {
        ...
        switch (match) {
            ...
            case MMS_OUTBOX_ID:
                ...
                return purgeSingleEntry(Uri.withAppendedPath(Uri.parse("content://mms"), msgId));  //Mms.CONTENT_URI
